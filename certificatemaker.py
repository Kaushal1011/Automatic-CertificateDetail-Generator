    ...
    with open('Names.csv', 'rt') as f:
        ...
        for row in data:
            ...
            font = ImageFont.truetype(
                'LIB_IT.ttf',
                90)  # write the path of the font which you want to select
            ...
            # if you want to add extra paramter change the .csv
            # as per you requirement and write this code again.
